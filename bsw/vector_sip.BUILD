...
genrule(
    name = "src_gen_rule",
    outs = [
        "src_gen/mbition-app-prototype/src/ara/com/resource_manager.cpp",
        "src_gen/mbition-app-prototype/src/ara/com/someip_resource_manager.cpp",
        "src_gen/mbition-app-prototype/src/ara/com/runtime_init.cpp",
        "src_gen/mbition-app-prototype/src/mbition/adas/proto/mbitionexampleserviceinterface_proxy.cpp",
        "src_gen/mbition-app-prototype/src/mbition/adas/proto/mbitionexampleserviceinterface.cpp",
        "src_gen/mbition-app-prototype/src/mbition/adas/proto/mbitionexampleserviceinterface_resource_manager.cpp",
        "src_gen/mbition-app-prototype/src/mbition/adas/proto/mbitionexampleserviceinterface_proxy_resource_manager.cpp",
        "src_gen/mbition-app-prototype/configuration/exec_config.json",
        "src_gen/mbition-app-prototype/configuration/someip_config.json",
        "src_gen/mbition-app-prototype/includes/ara/com/resource_manager.h",
        "src_gen/mbition-app-prototype/includes/ara/com/someip_resource_manager.h",
        "src_gen/mbition-app-prototype/includes/mbition/adas/proto/MbitionExampleServiceInterface_proxy_impl_interface.h",
        "src_gen/mbition-app-prototype/includes/mbition/adas/proto/mbitionexampleserviceinterface_proxy_resource_manager.h",
        "src_gen/mbition-app-prototype/includes/mbition/adas/proto/mbitionexampleserviceinterface_resource_manager.h",
        "src_gen/mbition-app-prototype/includes/mbition/adas/proto/MbitionExampleServiceInterface.h",
        "src_gen/mbition-app-prototype/includes/mbition/adas/proto/impl_type_event_buffer.h",
        "src_gen/mbition-app-prototype/includes/mbition/adas/proto/mbitionexampleserviceinterface_common.h",
        "src_gen/mbition-app-prototype/includes/mbition/adas/proto/MbitionExampleServiceInterface_types.h",
        "src_gen/mbition-app-prototype/includes/mbition/adas/proto/mbitionexampleserviceinterface_proxy.h",
        "src_gen/mbition-app-prototype/someip-posix/ara/com/aracom_someip_binding_init.cpp",
        "src_gen/mbition-app-prototype/someip-posix/mbition/adas/proto/MbitionExampleServiceInterface_proxy_fields_deserializer.h",
        "src_gen/mbition-app-prototype/someip-posix/mbition/adas/proto/MbitionExampleServiceInterface_proxy_someip_binding.h",
        "src_gen/mbition-app-prototype/someip-posix/mbition/adas/proto/MbitionExampleServiceInterface_proxy_someip_event_manager.h",
        "src_gen/mbition-app-prototype/someip-posix/mbition/adas/proto/MbitionExampleServiceInterface_proxy_someip_binding.cpp",
        "src_gen/mbition-app-prototype/someip-posix/mbition/adas/proto/MbitionExampleServiceInterface_proxy_fields_serializer.h",
        "src_gen/mbition-app-prototype/someip-posix/mbition/adas/proto/MbitionExampleServiceInterface_proxy_someip_event_manager.cpp",
        "src_gen/mbition-app-prototype/someip-posix/mbition/adas/proto/MbitionExampleServiceInterface_proxy_methods_serializer.h",
        "src_gen/mbition-app-prototype/someip-posix/mbition/adas/proto/MbitionExampleServiceInterface_proxy_methods_deserializer.h",
        "src_gen/mbition-app-prototype/someip-posix/mbition/adas/proto/MbitionExampleServiceInterface_someip_proxy_factory.h",
        "src_gen/mbition-app-prototype/someip-posix/mbition/adas/proto/MbitionExampleServiceInterface_proxy_someip_methods.h",
    ],
    srcs = [
        "//config/tools:model_gen_rule", #to Run gen_rule that will create the model_gen folder
    ...
    rm -rf $(@D)/src_gen
    mkdir $(@D)/src_gen
    $(location DaVinciConfigurator/Core/amsrgen.sh) -v \
    -g $(location Generators/amsr_diag_model) \
    -g $(location Generators/amsr_diag_api) \
    -g $(location Generators/amsr_diag_daemon) \
    -g $(location Generators/amsr_em_exec_config) \
    -g $(location Generators/amsr_com_ipc) \
    -g $(location Generators/amsr_com_someip) \
    -g $(location Generators/amsr_com_api) \
    -g $(location Generators/amsr_modelleddatatypes_api) \
    -x $(locations //config/tools:model_gen_rule) -o $(@D)/src_gen --saveProject
    """,
    tools = [
        "DaVinciConfigurator/Core/DVACfgCmd",
        "Generators/amsr_diag_model",
        "Generators/amsr_diag_api",
        "Generators/amsr_diag_daemon",
        "Generators/amsr_em_exec_config",
        "Generators/amsr_com_ipc",
        "Generators/amsr_com_someip",
        "Generators/amsr_com_api",
        "Generators/amsr_modelleddatatypes_api",
...
genrule(
    name = "src_gen_hdrs_rule",
    srcs = [
        ":src_gen_rule"
    ],
    cmd = """
        rm -rf $(@D)/src_gen_hdrs
        mkdir $(@D)/src_gen_hdrs
        for file in $(locations :src_gen_rule); do\
            final_path=`dirname $(@D)/src_gen_hdrs/$${file#$(@D)/src_gen/}`; \
            mkdir -p $$final_path; \
            cp $$file $$final_path; \
        done
    """,
    outs = [
        "src_gen_hdrs/mbition-app-prototype/includes/ara/com/resource_manager.h",
        "src_gen_hdrs/mbition-app-prototype/includes/ara/com/someip_resource_manager.h",
        "src_gen_hdrs/mbition-app-prototype/includes/mbition/adas/proto/MbitionExampleServiceInterface_proxy_impl_interface.h",
        "src_gen_hdrs/mbition-app-prototype/includes/mbition/adas/proto/mbitionexampleserviceinterface_proxy_resource_manager.h",
        "src_gen_hdrs/mbition-app-prototype/includes/mbition/adas/proto/mbitionexampleserviceinterface_resource_manager.h",
        "src_gen_hdrs/mbition-app-prototype/includes/mbition/adas/proto/MbitionExampleServiceInterface.h",
        "src_gen_hdrs/mbition-app-prototype/includes/mbition/adas/proto/impl_type_event_buffer.h",
        "src_gen_hdrs/mbition-app-prototype/includes/mbition/adas/proto/mbitionexampleserviceinterface_common.h",
        "src_gen_hdrs/mbition-app-prototype/includes/mbition/adas/proto/MbitionExampleServiceInterface_types.h",
        "src_gen_hdrs/mbition-app-prototype/includes/mbition/adas/proto/mbitionexampleserviceinterface_proxy.h",
    ]
)

genrule(
    name = "src_gen_someip_hdrs_rule",
    srcs = [
        ":src_gen_rule"
    ],
    cmd = """
        rm -rf $(@D)/src_gen_someip_hdrs
        mkdir $(@D)/src_gen_someip_hdrs
        for file in $(locations :src_gen_rule); do\
            final_path=`dirname $(@D)/src_gen_someip_hdrs/$${file#$(@D)/src_gen/}`; \
            mkdir -p $$final_path; \
            cp $$file $$final_path; \
        done
    """,
    outs = [
        "src_gen_someip_hdrs/mbition-app-prototype/someip-posix/mbition/adas/proto/MbitionExampleServiceInterface_proxy_fields_deserializer.h",
        "src_gen_someip_hdrs/mbition-app-prototype/someip-posix/mbition/adas/proto/MbitionExampleServiceInterface_proxy_someip_binding.h",
        "src_gen_someip_hdrs/mbition-app-prototype/someip-posix/mbition/adas/proto/MbitionExampleServiceInterface_proxy_someip_event_manager.h",
        "src_gen_someip_hdrs/mbition-app-prototype/someip-posix/mbition/adas/proto/MbitionExampleServiceInterface_proxy_fields_serializer.h",
        "src_gen_someip_hdrs/mbition-app-prototype/someip-posix/mbition/adas/proto/MbitionExampleServiceInterface_proxy_methods_serializer.h",
        "src_gen_someip_hdrs/mbition-app-prototype/someip-posix/mbition/adas/proto/MbitionExampleServiceInterface_proxy_methods_deserializer.h",
        "src_gen_someip_hdrs/mbition-app-prototype/someip-posix/mbition/adas/proto/MbitionExampleServiceInterface_someip_proxy_factory.h",
        "src_gen_someip_hdrs/mbition-app-prototype/someip-posix/mbition/adas/proto/MbitionExampleServiceInterface_proxy_someip_methods.h",
    ]
)


cc_library(
    name = "mbition_app_prototype_src_gen_hdrs",
    hdrs = [
        ":src_gen_hdrs_rule"
    ],
    strip_include_prefix = "src_gen_hdrs/mbition-app-prototype/includes/",
)

cc_library(
    name = "mbition_app_prototype_src_gen_someip_hdrs",
    hdrs = [
        ":src_gen_someip_hdrs_rule"
    ],
    strip_include_prefix = "src_gen_someip_hdrs/mbition-app-prototype/someip-posix/",
)

cc_library(
    name = "mbition_app_prototype_src_gen",
    srcs = [":src_gen_rule"],
    copts = [
        "-std=c++14",
    ],
    linkstatic = 1,
    deps= [
        ":mbition_app_prototype_src_gen_hdrs",
        ":mbition_app_prototype_src_gen_someip_hdrs",
        ":amsr-vector-fs-communicationmiddleware-headers",
        ":amsr-vector-fs-comcommon",
    ],
    visibility = ["//visibility:public"],
