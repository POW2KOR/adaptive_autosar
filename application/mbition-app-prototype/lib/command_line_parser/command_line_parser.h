 ...
 *
 *********************************************************************************************************************/
#ifndef SRC_MBITION_APP_PROTOTYPE_COMMANDLINEPARSER_COMMAND_LINE_PARSER_H_
#define SRC_MBITION_APP_PROTOTYPE_COMMANDLINEPARSER_COMMAND_LINE_PARSER_H_
...
/*!
 * PSE54 and therefore not available on all supported OSs. This implementation
 * supports: Simple arguments, e.g.:
 *
 *     gcc main.c
 *
 ...
 *
 * where OPTIONS is a string specifying allowed command line options where each
 * option represented by a single letter i.e. "-a", with optional ':' appended
 * to indicate that the option has an argument. An invalid OPTIONS string leads
 * to an empty list of options. GetOption() will return kInvalidOption in this
 * case. In debug build an invalid OPTIONS string leads to an assertion.
 *
 * Example:
 *
...
class CommandLineParser final {
     ...
     *
     * \details    Creates the command line parser and validates the given
     * command line arguments.
     *
     * \param[in]  argc             Number of command line arguments.
     * \param[in]  argv             Array containing the actual command line
     * arguments. \param[in]  allowed_options  String which specifies which
     * options are allowed and which options require an argument.
     */
    ...
    Iterator end() const noexcept {
        return Iterator{ *this, kInvalidIteratorIndex };
    }
...
#endif // SRC_MBITION_APP_PROTOTYPE_COMMANDLINEPARSER_COMMAND_LINE_PARSER_H_
