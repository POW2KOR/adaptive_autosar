...
class VariantCodingConsumer {
 ...
 private:
     ...
     ******************************************************************************/
    static void FindServiceHandler(ara::com::ServiceHandleContainer<services::ns_si_cnfg_mngr_to_dummyswc::
                                    proxy::SI_X6AA_Cnfg_Mngr_Service_ReservedProxy::HandleType>
    ...
    static std::shared_ptr<services::ns_si_cnfg_mngr_to_dummyswc::proxy::
         SI_X6AA_Cnfg_Mngr_Service_ReservedProxy> variant_coding_service_proxy;
