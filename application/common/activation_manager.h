 ...
 */
#ifndef SRC_ACTIVATION_MANAGER_H_
#define SRC_ACTIVATION_MANAGER_H_
...
class ActivationManagerBase {
 protected:
    ...
    struct timespec desired_wakeup_{};       /**< Desired absolute wakeup time */
    struct timespec actual_wakeup_{};        /**< Actual absolute wakeup time */
 ...
 public:
     ...
     * \brief Constructor.
     */
    explicit ActivationManagerBase(std::chrono::nanoseconds cycle_time, const std::string name = "activation manager");
...
class ActivationManagerTimer : public ActivationManagerBase {
 public:
     ...
     * \brief Constructor.
     */
    explicit ActivationManagerTimer(std::chrono::nanoseconds cycle_time, const std::string name = "activation manager");
...
#endif  // SRC_ACTIVATION_MANAGER_H_
