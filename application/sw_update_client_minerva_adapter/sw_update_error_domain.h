 ...
 * conditions. All other rights remain with Vector Informatik GmbH. \endverbatim
 *  -------------------------------------------------------------------------------------------------------------------
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/*!        \file
 ...
 */
enum class SwUpdateAppErrc : ara::core::ErrorDomain::CodeType {
    kUnknownError = 0,
 ...
 * \details This class represents an error domain responsible for all errors occurring in the
 * Skeleton Demo.
 */
...
public:
     ...
     */
    constexpr SkeletonDemoErrorDomain() noexcept
        : ErrorDomain(kId)
    {
    }
 ...
 */
inline constexpr ara::core::ErrorDomain const& GetTemplateErrorDomain()
{
    return internal::kTemplateErrorDomain;
}
...
SkeletonDemoErrorDomain::StringType SkeletonDemoErrorDomain::Message(
