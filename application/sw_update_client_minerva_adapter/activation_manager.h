...
class ActivationManagerBase {
  ...
  public:
     ...
     * \brief Constructor.
     ******************************************************************************/
    ActivationManagerBase(std::chrono::nanoseconds cycle_time, const std::string name = "activation manager");
...
class ActivationManagerTimer : public ActivationManagerBase {
  ...
  public:
     ...
     * \brief Constructor.
     ******************************************************************************/
    ActivationManagerTimer(std::chrono::nanoseconds cycle_time, const std::string name = "activation manager");
