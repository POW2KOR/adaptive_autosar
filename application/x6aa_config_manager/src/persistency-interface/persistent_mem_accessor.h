...
using activateSarStorage0131VcEventDataType = ::DataTypes::NS_REC_activateSarStorage0131VcEventType_t::REC_activateSarStorage0131VcEventType_t;
using configureSarTriggerEvents0136VcEventDataType = ::DataTypes::NS_REC_configureSarTriggerEvents0136VcEventType_t::REC_configureSarTriggerEvents0136VcEventType_t;
using vechicleInformation0400VcEventDataType = ::DataTypes::NS_REC_vechicleInformation0400VcEventType_t::REC_vechicleInformation0400VcEventType_t;
...
class PersistentMemAccessor {
 public:
  ...
  /**
   * \brief Funktion to construct and read ReadConfigureSarTriggerEvents0136VcEventData in key value storage.
   * \return configureSarTriggerEvents0136VcEventDataType Output data 
   */
  configureSarTriggerEvents0136VcEventDataType ReadConfigureSarTriggerEvents0136VcEventData();

  /**
   * \brief Funktion to construct and read ReadActivateSarStorage0131VcEventData in key value storage.
   * \return activateSarStorage0131VcEventDataType Output data 
   */
  activateSarStorage0131VcEventDataType ReadActivateSarStorage0131VcEventData();

  /**
   * \brief Funktion to construct and read ReadVechicleInformation0400VcEventData in key value storage.
   * \return vechicleInformation0400VcEventDataType Output data 
   */
  ...
  */
   ...
   */
  ara::log::Logger& logger_ctx{ara::log::CreateLogger("VPER", "Context for variant coding persistency")};
