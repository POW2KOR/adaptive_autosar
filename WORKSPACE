...
new_git_repository(
    ...
    commit = "0ef3edea01c312b634bff177851d216ae15c18bf",
...
new_git_repository(
    ...
    commit = "f610f201a9f4e423c633076d5ce1e87ba9b11f06",  # the commit ID that bazel will use to fetch the external repository
