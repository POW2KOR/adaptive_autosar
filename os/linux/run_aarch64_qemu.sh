...
if [ "$BOOT_INTO_ADAPTIVE_STACK" = true ] ; then
    ...
    guestfish -a adaptive_overlay.ext4.qcow2 -i ln-sf /lib/systemd/system/enable-ipv6-loopback.service /etc/systemd/system/multi-user.target.wants/enable-ipv6-loopback.service
fi
